...
const SECTIONS: { title: string; icon: string; tools: ToolCard[] }[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { emoji: "📂", name: "DankVault",             desc: "Master file vault — organized collection of your local builds & community presets", path: "/vault",  accent: "#d4a017", badge: "PRIME", tags: ["vault","files","download","community","json"] },
    ],
  },
  {
