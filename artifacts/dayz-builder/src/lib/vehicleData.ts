...
export const VEHICLES: VehicleDef[] = [
  ...
  },
  {
    ...
    icon: "🛻",
    desc: "Soviet-era civilian 4×4 utility vehicle (Niva-type — NOT a UAZ or Land Rover)",
    length: 4.5,
    width: 2.0,
    slots: [
  ...
  },
  {
    ...
    name: "M1025 HMMWV",
    icon: "🪖",
    desc: "Military Humvee — 4-door + open flatbed rear. Classname: Offroad_02 in types.xml",
    length: 4.6,
    width: 2.2,
    slots: [
  ...
  {
    id: "ural_covered",
    classname: "Ural_Covered",
    name: "Ural Truck (Covered)",
    icon: "🚛",
    desc: "Heavy Soviet military truck — canvas-covered cargo bed. Largest vanilla vehicle.",
    length: 9.0,
    width: 2.7,
    slots: [
      { id: "driver",      label: "Driver Cab",         offsetX: -0.65, offsetY: 1.5, offsetZ:  3.2, svgX: 64, svgY: 40 },
      { id: "co_driver",   label: "Co-Driver",          offsetX:  0.65, offsetY: 1.5, offsetZ:  3.2, svgX: 36, svgY: 40 },
      { id: "cargo_fl",    label: "Cargo Front-Left",   offsetX: -0.8,  offsetY: 1.1, offsetZ:  1.2, svgX: 64, svgY: 54 },
      { id: "cargo_fr",    label: "Cargo Front-Right",  offsetX:  0.8,  offsetY: 1.1, offsetZ:  1.2, svgX: 36, svgY: 54 },
      { id: "cargo_ml",    label: "Cargo Mid-Left",     offsetX: -0.8,  offsetY: 1.1, offsetZ: -0.3, svgX: 64, svgY: 65 },
      { id: "cargo_mr",    label: "Cargo Mid-Right",    offsetX:  0.8,  offsetY: 1.1, offsetZ: -0.3, svgX: 36, svgY: 65 },
      { id: "cargo_rl",    label: "Cargo Rear-Left",    offsetX: -0.8,  offsetY: 1.1, offsetZ: -1.8, svgX: 64, svgY: 77 },
      { id: "cargo_rr",    label: "Cargo Rear-Right",   offsetX:  0.8,  offsetY: 1.1, offsetZ: -1.8, svgX: 36, svgY: 77 },
      { id: "ground_left", label: "Ground Left",        offsetX: -1.9,  offsetY: 0.0, offsetZ:  0.0, svgX: 80, svgY: 62 },
      { id: "ground_right",label: "Ground Right",       offsetX:  1.9,  offsetY: 0.0, offsetZ:  0.0, svgX: 20, svgY: 62 },
    ],
  },
  {
    id: "ural_open",
    classname: "Ural_Open",
    name: "Ural Truck (Open Flatbed)",
    icon: "🚚",
    desc: "Heavy Soviet military truck — open flatbed bed with side rails.",
    length: 9.0,
    width: 2.7,
    slots: [
      { id: "driver",      label: "Driver Cab",         offsetX: -0.65, offsetY: 1.5, offsetZ:  3.2, svgX: 64, svgY: 40 },
      { id: "co_driver",   label: "Co-Driver",          offsetX:  0.65, offsetY: 1.5, offsetZ:  3.2, svgX: 36, svgY: 40 },
      { id: "bed_fl",      label: "Bed Front-Left",     offsetX: -0.8,  offsetY: 1.0, offsetZ:  1.2, svgX: 64, svgY: 54 },
      { id: "bed_fr",      label: "Bed Front-Right",    offsetX:  0.8,  offsetY: 1.0, offsetZ:  1.2, svgX: 36, svgY: 54 },
      { id: "bed_ml",      label: "Bed Mid-Left",       offsetX: -0.8,  offsetY: 1.0, offsetZ: -0.3, svgX: 64, svgY: 65 },
      { id: "bed_mr",      label: "Bed Mid-Right",      offsetX:  0.8,  offsetY: 1.0, offsetZ: -0.3, svgX: 36, svgY: 65 },
      { id: "bed_rl",      label: "Bed Rear-Left",      offsetX: -0.8,  offsetY: 1.0, offsetZ: -1.8, svgX: 64, svgY: 77 },
      { id: "bed_rr",      label: "Bed Rear-Right",     offsetX:  0.8,  offsetY: 1.0, offsetZ: -1.8, svgX: 36, svgY: 77 },
      { id: "ground_left", label: "Ground Left",        offsetX: -1.9,  offsetY: 0.0, offsetZ:  0.0, svgX: 80, svgY: 62 },
      { id: "ground_right",label: "Ground Right",       offsetX:  1.9,  offsetY: 0.0, offsetZ:  0.0, svgX: 20, svgY: 62 },
    ],
  },
  {
    id: "boat_small",
    classname: "Boat_Small",
    name: "Fishing Boat (Driveable)",
    icon: "⛵",
    desc: "Small wooden fishing boat — driveable. Static version is Land_Boat_Small9_DE.",
    length: 4.2,
    width: 1.8,
    slots: [
...
export const LOOT_ITEMS: LootItem[] = [
  ...
  { classname: "SedanWheel",            name: "Sedan Wheel",           category: "Vehicle"  },
  { classname: "OffroadWheel",         name: "Offroad Wheel",         category: "Vehicle"  },
