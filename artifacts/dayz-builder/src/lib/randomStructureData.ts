...
export interface ShellDef {
  ...
  type: "military" | "civilian" | "industrial";
}

export const SHELL_POOL: ShellDef[] = [
  { classname: "Land_Mil_Barracks1",       label: "Military Barracks 1",    w: 14, d: 8,  h: 4,  type: "military"   },
  { classname: "Land_Mil_Barracks2",       label: "Military Barracks 2",    w: 18, d: 10, h: 4,  type: "military"   },
  { classname: "Land_Mil_Barracks3",       label: "Military Barracks 3",    w: 22, d: 12, h: 5,  type: "military"   },
  { classname: "Land_Mil_Barracks_HQ_DE",  label: "Military HQ",            w: 20, d: 14, h: 5,  type: "military"   },
  { classname: "Land_Mil_Guardhouse1",     label: "Guard House 1",          w: 6,  d: 5,  h: 3,  type: "military"   },
  { classname: "Land_Mil_Guardhouse2",     label: "Guard House 2",          w: 8,  d: 6,  h: 3,  type: "military"   },
  { classname: "Land_House_1W02",          label: "Civilian House 1",       w: 10, d: 8,  h: 3,  type: "civilian"   },
  { classname: "Land_House_2W02",          label: "Civilian House 2",       w: 12, d: 9,  h: 3,  type: "civilian"   },
  { classname: "Land_Shed_W1",             label: "Wooden Shed",            w: 8,  d: 6,  h: 3,  type: "civilian"   },
  { classname: "Land_Shed_W2",             label: "Large Wooden Shed",      w: 12, d: 8,  h: 4,  type: "civilian"   },
  { classname: "Land_Ind_Workshop01",      label: "Industrial Workshop",    w: 20, d: 14, h: 6,  type: "industrial" },
  { classname: "Land_Ind_Shed_Ind2",       label: "Industrial Shed",        w: 16, d: 12, h: 5,  type: "industrial" },
];
...
export const BASE_PROPS: PropDef[] = [
  ...
  { classname: "PalletBox_DE",                 label: "Pallet Box",          color: "#6a4a1a", w: 1.2, h: 1.0, d: 1.0, wallAlign: true  },
  ...
  { classname: "StaticObj_Roadblock_Pillbox",  label: "Sandbag Nest",        color: "#8a7a5a", w: 3.0, h: 1.0, d: 1.5, wallAlign: true  },
  // Ammo / military
