...
export const MASTER_RULESET = {
  ...
  shape_registry: {
    ...
    shapes: {
      ...
      line: { type: "complex" },
      // ── Masterpiece generators ─────────────────────────────────────────────
      eiffel_tower:       { type: "masterpiece" },
      big_ben:            { type: "masterpiece" },
      parthenon:          { type: "masterpiece" },
      arc_triomphe:       { type: "masterpiece" },
      sagrada_familia:    { type: "masterpiece" },
      sydney_opera:       { type: "masterpiece" },
      space_needle:       { type: "masterpiece" },
      cn_tower:           { type: "masterpiece" },
      leaning_pisa:       { type: "masterpiece" },
      tower_pisa:         { type: "masterpiece" },
      pisa:               { type: "masterpiece" },
      london_eye:         { type: "masterpiece" },
      christ_redeemer:    { type: "masterpiece" },
      statue_liberty:     { type: "masterpiece" },
      statue_of_liberty:  { type: "masterpiece" },
      hogwarts:           { type: "masterpiece" },
      barad_dur:          { type: "masterpiece" },
      minas_tirith:       { type: "masterpiece" },
      tony_stark_tower:   { type: "masterpiece" },
      xwing:              { type: "masterpiece" },
      x_wing:             { type: "masterpiece" },
      leaning_tower:      { type: "masterpiece" },
      skyscraper:         { type: "masterpiece" },
      shipwreck:          { type: "masterpiece" },
      petra_treasury:     { type: "masterpiece" },
      empire_state:       { type: "masterpiece" },
      golden_gate:        { type: "masterpiece" },
    },
    on_undefined_shape: "WARN"
  },
